...
class SettigsNeural():
    ...
    def createInterfaceMenu(self):
        ...
        self.backGroundMenuIfor = pygame.transform.scale(self.backGroundMenuIfor,(315,160))
        self.buttonModelImage1 = pygame.transform.scale(self.backGroundMenuIfor,(250,25))
