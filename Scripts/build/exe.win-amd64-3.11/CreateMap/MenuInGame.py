...
class MenuInGame():
    def __init__(self,parent) -> None:
        ...
        self.menuSettigs = setttigs.SettigsNeural()
    ...
    def eventsButs(self):
        ...
        if self.buttonButPauser.checkInput(mousePos):
            self.parent.inPause = True if self.parent.inPause == False else False
            self.buttonButPauser.labelInput  = "PAUSER" if  self.parent.inPause == False else "RESUME"
